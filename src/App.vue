		...
		<div class="main">
			<div class="player-side">
				...
				<div class="to-the-right">
					...
					<img  v-if="player_choice === 'rock'" v-bind:src="'./assets/' + rockImg" alt="rock"/>
					<img  v-if="player_choice === 'paper'" v-bind:src="'./assets/' + paperImg" alt="paper" />
					<img  v-if="player_choice === 'scissors'" v-bind:src="'./assets/' + scissorsImg" alt="scissors"/>
				</div>
			</div>
			<!-- Computer's side -->
